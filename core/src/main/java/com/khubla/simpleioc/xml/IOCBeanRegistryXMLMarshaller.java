package com.khubla.simpleioc.xml;
...
public class IOCBeanRegistryXMLMarshaller {
	/**
	 * marshall
	 */
	...
	public static void marshall(Beans beans, OutputStream outputStream) throws Exception {
		try {
			...
			final Schema schema = schemaFactory.newSchema(IOCBeanRegistryXMLMarshaller.class.getResource("/autobeans.xsd"));
